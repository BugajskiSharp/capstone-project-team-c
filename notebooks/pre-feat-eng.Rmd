...
Looking at the full dataset for missing values (ZD)
```{r}
...
#Spiting the data so Berlin is used as a second case study to show how the method performs with missing data (whether successful or not). (KB)
```{r}
...
Observing categorical variables and their distributions: (KB)
```{r}
